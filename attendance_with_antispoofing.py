...
def login():
    if username_var.get() == "" or password_var.get() == "":
        ...
        try:
            conn = pymysql.connect(host = 'localhost', user = 'root', password = 'atharv@2003', database = 'recognition')
            curr = conn.cursor()
            ...
            if row == None:
                ...
                def manage_student():
                    ...
                    #Student Management form 
                        ...
                        post = Label(f2, text = "Branch", bg = "gray",  font = ("italic",13, "bold")).place(x = 35, y = 150 )
                        ...
                        btn1 = Button(f3, text = "Add", bg = "green", height = "1", width = "7",command = add_student, font = ("Times new Roman", 14 , "bold")).place(x = 10, y = 10)
    ...
    #Function to recognize the face
                ...
                manage = 'Automatic Entry Registration System'
                ...
                B1 = Button(attendance, image = photo1, text = "Student Management",font = ("Times New Roman" , 15), fg = "green", height =230, width = 265, command = manage_student, compound = BOTTOM )
                B1.place(x = 20, y = 100)
