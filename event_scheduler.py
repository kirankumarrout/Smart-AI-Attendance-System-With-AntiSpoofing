...
def send_mail():
    ...
    server.starttls()
    server.login('project.cs300@gmail.com','kkr@1234')
    for email in absent_staff_emails:
        server.sendmail('project.cs300@gmail.com',
                    email,
                    'You are absent')
    ...
    msg['From'] = 'project.cs300@gmail.com'
    ...
    with smtplib.SMTP_SSL('smtp.gmail.com',465) as smtp:
        smtp.login('project.cs300@gmail.com','kkr@1234')
...
sched.add_job(send_mail,'cron',day_of_week='mon-sun', hour=22, minute=00)
sched.start()
